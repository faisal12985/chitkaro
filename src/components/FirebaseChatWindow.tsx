...
export function FirebaseChatWindow() {
  ...
  const { activeChat, messages, sendMessage, setTyping } = useFirebaseChat();
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 max-w-sm">
            🔥 <strong>Real Firebase Chat!</strong><br />
            Select a user from the sidebar to start a real-time conversation. 
            All messages are stored in Firebase and sync across devices!
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        {chatMessages.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-green-600 mt-2">✨ This is a real Firebase chat - messages will sync in real-time!</p>
          </div>
        ) : (
        ...
        {/* Typing Indicator - For future implementation */}
