...
function App() {
  ...
  const [connectionStatus, setConnectionStatus] = useState('Connecting to Firebase...');
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">🔥 ChitChat - Firebase Chat</h1>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md max-w-md mx-auto">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-700">
                <strong>Firebase Integration Status:</strong><br/>
                {connectionStatus.includes('❌') ? 
                  'Please check Firebase configuration and rules.' :
